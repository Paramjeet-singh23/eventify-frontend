  ...
  <header class="relative w-full border-b bg-white pb-4">
    <div class="mx-auto flex max-w-7xl items-center justify-between px-4 py-2">
      <div class="inline-flex items-center space-x-2">
        ...
        <span class="font-bold">Eventify</span>
      </div>
  ...
  <div class="relative w-full bg-white">
    <div class="mx-auto max-w-7xl lg:grid lg:grid-cols-12 lg:gap-x-8 lg:px-8">
      <div class="flex flex-col justify-center px-4 py-12 md:py-16 lg:col-span-7 lg:gap-x-6 lg:px-6 lg:py-24 xl:col-span-6">
        ...
        Boost your event with QR code access and key data insights,
         streamlining planning for unforgettable experiences.
        </p>
  ...
  <div class="mx-auto my-32 max-w-7xl px-2 lg:px-8">
    <div class="grid grid-cols-1 gap-y-8 text-center sm:grid-cols-2 sm:gap-12 lg:grid-cols-4">
      <div>
        ...
        Transaction safety is a priority; we safeguard your details with robust encryption.
        </p>
      </div>
      <div>
        ...
        <p class="mt-4 text-sm text-gray-600">
        Speedy loading times meet convenience, ensuring you're always just a click away.
        </p>
      </div>
      <div>
        ...
        <p class="mt-4 text-sm text-gray-600">
        Adaptable display options offer comfort for your eyes, day or night.
        </p>
      </div>
      <div>
        ...
        <p class="mt-4 text-sm text-gray-600">
        Navigate with ease using our intuitive filters to quickly locate what you seek.
        </p>
      </div>
    </div>
  </div>
